disease_dic = {
    ...
    'Apple___Cedar_apple_rust': """ <b>Crop</b>: Rice <br/>Disease: Leaf Blast <br/>
        <br/> Cause of disease:

        <br/><br/>Leaf Blast : Severe cases of infection - entire crop give a blasted or burnt appearance- hence the name "BLAST"
Severe cases - lodging of crop (after ear emergence)

        <br/><br/> How to prevent/cure the disease <br/>
        <br/>1. Silicon fertilizers (e.g., calcium silicate) can be applied to soils that are silicon deficient to reduce blason.

        <br/>2. Plant the least-susceptible varieties and use a broad-spectrum seed treatment.
        
        <br/>3. Grow rice in open fields free of tree lines particularly on east and south sides..""",
